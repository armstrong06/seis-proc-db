...
class BasePyTable(ABC):
    ...
    def __init__(self, expected_array_length):
        ...
        self._h5_file, self._table = self._open_file(
            self.TABLE_NAME,
            self.TABLE_TITLE,
    ...
    def _set_table_metadata(self):
        attrs = self._table.attrs
...
class WaveformPyTable(BasePyTable):
    TABLE_NAME = "waveform"
...
class DLDetectorOutputPyTable(BasePyTable):
